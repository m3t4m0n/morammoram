...
class ContestsControllerTest < ActionController::TestCase
  ...
  test "should create contest" do
    assert_difference('Contest.count') do
      post :create, contest: { category: @contest.category, introduce: @contest.introduce, period: @contest.period, title: @contest.title }
    end
  ...
  test "should update contest" do
    patch :update, id: @contest, contest: { category: @contest.category, introduce: @contest.introduce, period: @contest.period, title: @contest.title }
    assert_redirected_to contest_path(assigns(:contest))
  end
